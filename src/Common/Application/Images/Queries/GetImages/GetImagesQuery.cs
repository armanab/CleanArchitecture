...
namespace CleanApplication.Application.Images.Queries.GetImages
{
    ...
    public class GetImagesQueryHandler : IRequestHandlerWrapper<GetImagesQuery, PaginatedList<ImageDto>>
    {
